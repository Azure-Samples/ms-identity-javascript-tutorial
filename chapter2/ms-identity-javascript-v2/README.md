...
1. Next, click the **See my profile** button on the left. This will make a Graph call.
1. Click the **read my mails** button below to see your mails on the Exchange service.
