...
description: "Vanilla JavaScript Single-page Application built with MSAL.js 2.x using Authorization Code Flow (w/ PKCE) to authenticate users against Azure AD B2C"
---

| In this Tutorial | Previous Tutorial | Next Tutorial | All Content |
|------------------|------------------|----------------|------------|
| authentication (B2C), id tokens, single sign-on, user-flows, custom policies | | [Call a web API protected by Azure AD B2C](https://github.com/Azure-Samples/ms-identity-b2c-javascript-signin) | [Table of Contents](https://github.com/Azure-Samples/ms-identity-javascript-tutorial) |

# Vanilla JavaScript Single-page Application built with MSAL.js 2.x using Authorization Code Flow (w/ PKCE) to authenticate users against Azure AD B2C
...
##### Update the Azure AD B2C app registration for `ms-identity-b2c-javascript-signin`

1. Navigate back to to the [Azure portal](https://portal.azure.com).
1. In the left-hand navigation pane, select the **Azure Active Directory B2C** service, and then select **App registrations**.
1. In the resulting screen, select the `ms-identity-b2c-javascript-signin` application.
1. From the *Branding* menu, update the **Home page URL**, to the address of your service, for example [https://ms-identity-b2c-javascript-signin-contoso.azurewebsites.net](https://ms-identity-b2c-javascript-signin-contoso.azurewebsites.net). Save the configuration.
