...
1. In the app's registration screen, click on the **API Permissions** blade in the left to open the page where we add access to the APIs that your application needs.
    ...
    - In the list of APIs, select the API you have just registered, i.e. `ms-identity-javascript-c3s1-api`.
...
Continue with the next tutorial: [Call a protected web API that calls Microsoft Graph on-behalf-of a user](../../4-AdvancedGrants/4-1-call-api-graph/README-incremental.md).
